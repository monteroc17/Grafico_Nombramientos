class Datos {
    ...
    obtenerPorDia(dia) {
        return this.datos.filter(elemento => {
            return elemento.rdia.split('-')[2] === dia;
        })
    }
    filtrarMeses() {
        let meses = [];
        ...
        this.datos.forEach(elemento => {
            meses.push(elemento.rdia.split('-')[1])
        })
    ...
    obtenerPorAnio(anio) {
        return this.datos.filter(elemento => {
            return elemento.rdia.split('-')[0] === anio;
        })
    }
    obtenerPorMes(mes) {
        return this.datos.filter(elemento => {
            return elemento.rdia.split('-')[1] === mes;
        })
    }
...
console.log('data by month', datos.obtenerPorMes('02'));
console.log('data by day', datos.obtenerPorDia('12'));
